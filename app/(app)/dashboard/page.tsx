  ...
  return (
    <div className="px-4 py-5 max-w-lg mx-auto space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-[#27272a] rounded-xl p-4 text-center">
      ...
      {collected === 0 && (
        <div className="bg-[#27272a] rounded-2xl p-5 text-center">
          <p className="text-2xl mb-2">📦</p>
          <p className="text-sm font-medium text-zinc-200">No stickers yet</p>
          <p className="text-xs text-zinc-500 mt-1">Head to Packs to log your first pack</p>
        </div>
      )}
    </div>
  );
